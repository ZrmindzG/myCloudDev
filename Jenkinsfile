        ...
        stage('docker image scanning'){
          ...
          stage('Docker Image push to  Amazon ECR'){
                      ...
                      withDockerRegistry([credentialsId:'ecr:ap-south-1:ecr-credentials',url:"https://823776493639.dkr.ecr.ap-south-1.amazonaws.com"]){
                       ...
                       docker tag :latest 823776493639.dkr.ecr.ap-south-1.amazonaws.com/dockerrepo/makemytrip-ms:test
                       echo ”tagging the docker Image: Completed”
                       echo “push docker image to ECR : In progress”
                       docker push part of 823776493639.dkr.ecr.ap-south-1.amazonaws.com/dockerrepo/makemytrip-ms:test
